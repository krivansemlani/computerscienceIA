        ...
        <table class="table">
            ...
            <tbody>
                @foreach ($revisionQuestions as $revisionQuestion)
                    <tr class="revision-question-row" data-subject-id="{{ $revisionQuestion->chapter->subject->id }}" data-chapter-id="{{ $revisionQuestion->chapter->id }}">
                        ...
                        <td>
                            ...
                            <button class="btn btn-danger" onclick="confirmDelete('{{ $revisionQuestion->id }}')">Delete</button>
                            <form id="deleteForm{{ $revisionQuestion->id }}" action="{{ route('revision-questions.destroy', $revisionQuestion->id) }}" method="POST" class="inline-block">
                                @csrf
                                @method('DELETE')
                            </form>
                        </td>
