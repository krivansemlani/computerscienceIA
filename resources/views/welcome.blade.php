            ...
            @if (Route::has('login'))
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    ...
                    @else
                        ...
                        <a href="{{ route('login') }}" id="loginBtn" class="ml-4 font-semibold text-gray-600 dark:text-gray-400 opacity-50 cursor-not-allowed">Log in</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" id="registerBtn" class="ml-4 font-semibold text-gray-600 dark:text-gray-400 opacity-50 cursor-not-allowed">Register</a>
                        @endif
                    @endauth
                </div>
            @endif
