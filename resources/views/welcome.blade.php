...
<div class="max-w-2xl mx-auto p-6 text-justify text-gray-600 "":text-gray-400">
                ...
                document.addEventListener('DOMContentLoaded', function () {
                    ...
                    function updateButtonsState() {
                        if (agreeTermsCheckbox.checked) {
                            ...
                            loginBtn.removeEventListener('click', preventDefaultAction);
                            registerBtn.removeEventListener('click', preventDefaultAction);
                        } else {
                            loginBtn.classList.add('opacity-50', 'cursor-not-allowed');
                            registerBtn.classList.add('opacity-50', 'cursor-not-allowed');
                            loginBtn.addEventListener('click', preventDefaultAction);
